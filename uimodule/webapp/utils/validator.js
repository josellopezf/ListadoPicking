...
sap.ui.define([
    ...
    Validator.prototype._validate = function (oControl) {
        var aPossibleAggregations = ["items", "content", "form", "formContainers", "formElements", "fields", "sections", "subSections", "_grid", "subHeader", "steps", 'columns', 'template'],
...
//                            console.log(aPossibleAggregations[i]);
